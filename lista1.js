...
let name = prompt("Digite aqui o seu nome.");
alert(`Olá, ${name}`);
...
let n1 = Number(prompt("Digite aqui a nota 1."));
let n2 = Number(prompt("Digite aqui a nota 2"));
let n3 = Number(prompt("Digite aqui a nota 3"));
let n4 = Number(prompt("Digite aqui a nota 4"));
...
let PL = Number(prompt("Digite aqui o Km do carro."));
let KL = Number(prompt("Digite aqui o litro."));
let KT = Number(prompt("Digite aqui o preco."));
let resultado = KT * (PL / KL);
console.log(`O veiculo pode percorrer ${resultado} por cada litro`);

// A velocidade média de um veículo pode ser calculada se tivermos os seguintes valores: a distância percorrida e o tempo gasto para percorrer esta distância. Com base nisso, elabore um algoritmo que leia uma distância percorria em quilômetros e o tempo gasto em horas, e informe a velocidade média desse veículo.

let position_final = Number(prompt("Digite o final da partida aqui."));
let position_inicial = Number(prompt("Digite o inicial da partida aqui."));
let time_final = Number(prompt("Digite o final do tempo aqui."));
let time_inicial = Number(prompt("Digite o inicial do tempo aqui."));
let pf_pi = position_final - position_inicial;
let tf_ti = time_final - time_inicial;
console.log(`A velocidade média do veiculo e de : `, pf_pi / tf_ti);
